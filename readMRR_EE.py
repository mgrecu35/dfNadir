fname='iphex_MRR2-04_20140612_EdneyvilleElementary_N352222.19_W822211.96.pro'
#fname='iphex_MRR2-02_20140611_MtPisgah_N352532.82_W824526.28.pro'
#fname='iphex_MRR2-01_20140611_PolkCountyEMATower_N351734.29_W821014.52.pro'
...
plt.xlabel('Time')
plt.ylabel('Height (km)')
plt.savefig('EdneyEle_June12.png')
